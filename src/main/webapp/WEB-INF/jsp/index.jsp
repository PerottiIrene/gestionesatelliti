			  ...
			  <div class="container">
			     ...
			     <div class="p-5 mb-4 bg-light rounded-3">
				      <div class="container-fluid py-5">
				        ...
				        <a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/satellite/confermaDisabilita">Disabilita Tutti</a>
				      </div>
			    </div>
			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    ...
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      <div class="feature col">
			        ...
			        <h2>Satelliti lanciati da piu di due anni che non sono ancora disattivati</h2>
			        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
			        <a href="satellite/ricerca1" class="icon-link">
			          Vai alla funzionalità
			          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
			        </a>
			      </div>
			      <div class="feature col">
			        ...
			        <h2>Satelliti che non sono rientrati e lo stato e' disattivato </h2>
			        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
			        <a href="satellite/ricerca2" class="icon-link">
			          Vai alla funzionalità
			          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
			        </a>
			      </div>
			      <div class="feature col">
			        ...
			        <h2>Satelliti rimasti in orbita 10 anni e non ancora rientrati</h2>
			        <p>Paragraph of text beneath the heading to explain the heading. We'll add onto it with another sentence and probably just keep going until we run out of words.</p>
			        <a href="satellite/ricerca3" class="icon-link">
			          Vai alla funzionalità
			          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
			        </a>
			      </div>
